words = ["a","ability","able","about","above","accept"
         ,"according","account","across","act","action"
         ,"activity","actually","add","address","administration"
         ,"admit","adult","affect","after","again","against","age"
         ...
         ,"available","avoid","away","baby","back","bad","bag","ball","bank"
         ...
         ,"campaign","can","cancer","candidate","capital","car","card","care"
         ...
         ,"could","country","couple","course","court","cover","create","crime","cultural"
         ...
         ,"director","discover","discuss","discussion","disease","do","doctor","dog","door"
         ,"down","draw","dream","drive","drop","drug","during","each","early","east","easy"
         ,"eat","economic","economy","edge","education","effect","effort","eight","either"
         ,"election","else","employee","end","energy","enjoy","enough","enter","entire"
         ,"environment","environmental","especially","establish","even","evening","event"
         ...
         ,"interview","into","investment","involve","issue","it","item","its","itself"
         ,"job","join","just","keep","key","kid","kill","kind","kitchen","know","knowledge"
         ,"land","language","large","last","late","later","laugh","law","lawyer","lay","lead"
         ,"leader","learn","least","leave","left","leg","legal","less","let","letter","level"
         ...
         ,"many","market","marriage","material","matter","may","maybe","me","mean"
         ...
         ,"news","newspaper","next","nice","night","no","none","nor","north","not","note","nothing"
         ,"notice","now","n't","number","occur","of","off","offer","office","officer","official"
         ...
         ,"picture","piece","place","plan","plant","play","player","PM","point","police","policy","political"
         ...
         ,"risk","road","rock","role","room","rule","run","safe","same","save","say","scene","school"
         ,"science","scientist","score","sea","season","seat","second","section","security","see","seek"
         ,"seem","sell","send","senior","sense","series","serious","serve","service","set","seven","several"
         ...
         ,"source","south","southern","space","speak","special","specific","speech","spend","sport","spring"
         ...
         ,"then","theory","there","these","they","thing","think","third","this","those","though","thought"
         ,"thousand","threat","three","through","throughout","throw","thus","time","to","today","together"
         ,"tonight","too","top","total","tough","toward","town","trade","traditional","training","travel"
         ...
         ,"wish","with","within","without","woman","wonder","word","work","worker","world","worry","would","write"
         ,"writer","wrong","yard","yeah","year","yes","yet","you","young","your","yourse"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            "lf"]

#------------------------------------------QUESTİON1

c1 = int (input("enter value between 1 and 999 for c1 "))


while c1 < 1 or c1 > 999 :
    c1 = int(input("enter valid value for c1 "))


c2 = int (input("enter value between 1 and 999 for c2 "))

while c2 < 1 or c2 > 999 :
    c2 = int(input("enter greater number for c2"))

if c1 < c2 :
    while c2 > c1:
        c1 = int(input("enter greater number for c1"))
...
btw_3and7 = int (input("enter between 3 and 7"))
while btw_3and7<3 or btw_3and7>7:
    btw_3and7 = int(input("enter between 3 and 7 !"))

password = ""
for i in range(btw_3and7):
...
for i in range (8):
    sifre = ""
    btw_3_7 = int(input("enter between 3 and 7"))
    while btw_3_7 < 3 or btw_3_7 > 7:
        btw_3_7 = int(input("enter valid"))
    for j in range (btw_3_7):
        sifre += words[random.randint(1,999)]
    if btw_3_7 < 5:
        shorter_set.add(sifre)
    if btw_3_7 >= 5:
        longer_set.add(sifre)
...
remove_item = int (input("enter between 1 to 30"))

while remove_item<1 or remove_item>30:
     remove_item = int (input("enter valid"))
...
for key,value in sorted_united_we_stand.items():
    print(key,value)
